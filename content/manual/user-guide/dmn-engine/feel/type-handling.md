...
[Supported Data Types in DMN]: {{< ref "/manual/user-guide/dmn-engine/data-types.md#supported-data-types" >}}
[FEEL Engine Spin Integration]: {{< ref "/manual/user-guide/dmn-engine/feel/spin-integration.md" >}}
