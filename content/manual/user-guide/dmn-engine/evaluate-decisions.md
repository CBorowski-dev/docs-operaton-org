...
In addition to parsing all contained decisions of a [decision requirements graph]({{< ref "/manual/reference/dmn/drg/_index.md" >}}) (DRG), the DMN engine can also parse the DRG itself from an `InputStream` or a `DmnModelInstance`.
...
[decision requirements graph]: {{< ref "/manual/reference/dmn/drg/_index.md" >}}
[decision requirements diagram]: {{< ref "/manual/reference/dmn/drg/_index.md" >}}
[required decisions]: {{< ref "/manual/reference/dmn/drg/_index.md#required-decisions" >}}
[hit policy]: {{< ref "/manual/reference/dmn/decision-table/hit-policy.md" >}}
[COLLECT]: {{< ref "/manual/reference/dmn/decision-table/hit-policy.md#collect-hit-policy" >}}
[RULE ORDER]: {{< ref "/manual/reference/dmn/decision-table/hit-policy.md#rule-order-hit-policy" >}}
