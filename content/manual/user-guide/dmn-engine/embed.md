...
This section gives more insights of embedded DMN engine configuration. In case you want to use DMN engine as part of the BPMN engine, please refer to the [DMN Engine Configuration]({{< ref "/manual/user-guide/process-engine/decisions/configuration" >}})  section of the [User Guide]({{< ref "/manual/user-guide/_index.md" >}}) for the configuration in that scenario.
...
[data types]: {{< ref "/manual/user-guide/dmn-engine/data-types.md" >}}
[hit policies]: {{< ref "/manual/reference/dmn/decision-table/hit-policy.md" >}}
[SLF4J]: http://www.slf4j.org/
[LOGBack]: http://logback.qos.ch/
[user manual]: http://www.slf4j.org/manual.html
[DMN decision table]: {{< ref "/manual/reference/dmn/decision-table/_index.md" >}}
[DMN decision literal expression]: {{< ref "/manual/reference/dmn/decision-literal-expression/_index.md" >}}
[expressions]: {{< ref "/manual/user-guide/dmn-engine/expressions-and-scripts.md" >}}
