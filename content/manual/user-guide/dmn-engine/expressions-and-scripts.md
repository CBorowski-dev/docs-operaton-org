...
output entries and literal expressions [here]({{< ref "/manual/reference/deployment-descriptors/tags/process-engine.md#dmnFeelEnableLegacyBehavior" >}}).
{{< /note >}}
...
[default EL]: {{< ref "/manual/user-guide/dmn-engine/embed.md#change-default-expression-languages" >}}
[configure EL]: {{< ref "/manual/user-guide/dmn-engine/embed.md#customize-expression-and-script-resolving" >}}
