...
You can find a list of currently supported batch types in the [Batch operations]({{< ref "/manual/user-guide/process-engine/batch-operations.md">}}).
...
[migration]: {{< ref "/manual/user-guide/process-engine/process-instance-migration.md" >}}
[batch-migration]: {{< ref "/manual/user-guide/process-engine/process-instance-migration.md#asynchronous-batch-migration-execution" >}}
...
[seed job]: #seed-job
[retry]: {{< ref "/manual/user-guide/process-engine/the-job-executor.md#failed-jobs" >}}
[incidents]: {{< ref "/manual/user-guide/process-engine/incidents.md" >}}
[history level]: {{< ref "/manual/user-guide/process-engine/history/history-configuration.md#choose-a-history-level" >}}
[history cleanup]: {{< ref "/manual/user-guide/process-engine/history/history-cleanup.md#history-time-to-live-for-batch-operations" >}}
[job prioritization]: {{< ref "/manual/user-guide/process-engine/the-job-executor.md#job-prioritization" >}}
[job-definition-priority]: {{< ref "/manual/user-guide/process-engine/the-job-executor.md#override-priority-by-job-definition" >}}
[job-priority]: {{< ref "/manual/user-guide/process-engine/the-job-executor.md#set-job-priorities-via-managementservice-api" >}}
[invoc-per-batch-job-batch-type]: {{< ref "/manual/reference/deployment-descriptors/tags/process-engine.md#invocations-per-batch-job-by-batch-type" >}}
[Process Engine Plugin]: {{< ref "/manual/user-guide/process-engine/process-engine-plugins.md" >}}
[spring-xml-config]: {{< ref "/manual/user-guide/spring-framework-integration/configuration.md" >}}
[spring-boot-config]: {{< ref "/manual/user-guide/spring-boot-integration/configuration.md#camunda-engine-properties" >}}