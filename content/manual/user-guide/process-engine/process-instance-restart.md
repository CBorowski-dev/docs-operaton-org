...
For information about the instruction types, please refer to the similar
 [modification instruction types]({{< ref "/manual/user-guide/process-engine/process-instance-modification.md#modification-instruction-types" >}}) section.
...
(non-blocking) by using a [batch]({{< ref "/manual/user-guide/process-engine/batch.md" >}}) .
...
See the [batch]({{< ref "/manual/user-guide/process-engine/batch.md" >}}) section for more
