...
In case of specific needs, you can also create a [custom history level]({{< ref "/manual/user-guide/process-engine/history/custom-implementation.md#implement-a-custom-history-level">}}).
...
[Operaton Cockpit]({{< ref "/manual/webapps/cockpit/_index.md" >}}) web application works best with History Level set to `FULL`. "Lower" History Levels will disable certain history-related features.
{{< /note >}}
