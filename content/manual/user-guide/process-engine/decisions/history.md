...
[Cockpit]: {{< ref "/manual/webapps/cockpit/dmn/_index.md" >}}
[History and Audit Event Log]: {{< ref "/manual/user-guide/process-engine/history/history-configuration.md" >}}
[DMN 1.3 reference]: {{< ref "/manual/reference/dmn/decision-table/hit-policy.md" >}}
[BPMN business rule task]: {{< ref "/manual/reference/bpmn20/tasks/business-rule-task.md#using-camunda-dmn-engine" >}}
[CMMN decision task]: {{< ref "/manual/reference/cmmn11/tasks/decision-task.md" >}}
