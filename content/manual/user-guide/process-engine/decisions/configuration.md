...
Follow the [instructions]({{< ref "/manual/user-guide/process-engine/process-engine-bootstrapping.md#configure-process-engine-using-spring-xml" >}}) to create a base `camunda.cfg.xml` XML configuration for the process engine.
...
[Process Engine Bootstrapping]: {{< ref "/manual/user-guide/process-engine/process-engine-bootstrapping.md" >}}
[DMN Engine Configuration]: {{< ref "/manual/user-guide/dmn-engine/embed.md#configuration-of-the-dmn-engine" >}}
