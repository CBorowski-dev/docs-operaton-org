...
In addition to the decision definitions, the [decision requirements graph]({{< ref "/manual/reference/dmn/drg/_index.md" >}}) (i.e., the `definitions` element in the XML) of a deployed DMN resource is transformed into a *Decision Requirements Definition*. It has, among others, these attributes:
...
Service]({{< ref "/manual/user-guide/process-engine/authorization-service.md" >}}) section.

# Cockpit

Deployed decision definitions can be viewed in the [Cockpit] webapp.

[Deployment]: {{< ref "/manual/user-guide/process-engine/deployments.md" >}}
[DMN 1.3]: {{< ref "/manual/reference/dmn/_index.md" >}}
[Process Application]: {{< ref "/manual/user-guide/process-applications/_index.md" >}}
[Process Archive]: {{< ref "/manual/reference/deployment-descriptors/tags/process-archive.md" >}}
