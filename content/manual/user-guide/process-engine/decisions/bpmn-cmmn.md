...
These APIs are **not** part of the [public API]({{< ref "/manual/introduction/public-api.md" >}}) and may change in later releases.
...
[decision table]: {{< ref "/manual/reference/dmn/decision-table/_index.md" >}}
[decision literal expression]: {{< ref "/manual/reference/dmn/decision-literal-expression/_index.md" >}}
[deployed]: {{< ref "/manual/user-guide/process-engine/decisions/repository.md" >}}
[business rule task]: {{< ref "/manual/reference/bpmn20/tasks/business-rule-task.md" >}}
[decision task]: {{< ref "/manual/reference/cmmn11/tasks/decision-task.md" >}}
[Typed Value API]: {{< ref "/manual/user-guide/process-engine/variables.md#typed-value-api" >}}
[object value serialization]: {{< ref "/manual/user-guide/process-engine/variables.md#object-value-serialization" >}}
[output variable mapping]: {{< ref "/manual/user-guide/process-engine/variables.md#input-output-variable-mapping" >}}
[execution listener]: {{< ref "/manual/user-guide/process-engine/delegation-code.md#execution-listener" >}}
[expression languages]: {{< ref "/manual/user-guide/dmn-engine/expressions-and-scripts.md" >}}
[FEEL]: {{< ref "/manual/reference/dmn/feel/_index.md" >}}
