...
in various situations such as [heterogeneous clusters]({{< ref "/manual/user-guide/process-engine/the-job-executor.md#cluster-setups" >}}),
...
3. The behavior of the activity is executed: the actual behavior depends on the type of the
   activity: in case of a `Service Task` the behavior consists of invoking [Delegation Code]({{< ref "/manual/user-guide/process-engine/delegation-code.md" >}}), in case of a `User Task`, the behavior consists of creating a `Task` instance in the task list etc...
...
Executor]({{< ref "/manual/user-guide/process-engine/the-job-executor.md" >}}).
...
[tx-spring]: {{< ref "/manual/user-guide/spring-framework-integration/transactions.md" >}}
[tx-jta]: {{< ref "/manual/user-guide/cdi-java-ee-integration/jta-transaction-integration.md" >}}
