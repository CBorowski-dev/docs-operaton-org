...
we recommend combining migration with the [process instance modification API]({{< ref "/manual/user-guide/process-engine/process-instance-modification.md" >}}), e.g.,
...
[set transient variables]: {{< ref "/manual/user-guide/process-engine/variables.md#transient-variables" >}}
...
* A set variable must not be of type `Object` **AND** its `serializationFormat` must not be `application/x-java-serialized-object`
  ...
  * Please see [Process Engine Configuration Reference]({{< ref "/manual/reference/deployment-descriptors/tags/process-engine.md#javaSerializationFormatEnabled" >}}) for more details
...
ref "/manual/user-guide/process-engine/process-instance-migration.md" >}}):
...
[batch]: {{< ref "/manual/user-guide/process-engine/batch.md" >}}
[job executor]: {{< ref "/manual/user-guide/process-engine/the-job-executor.md#job-execution-in-heterogeneous-clusters" >}}
[execution jobs]: {{< ref "/manual/user-guide/process-engine/batch.md#execution-jobs" >}}
...
[Object type variables]({{< ref "/manual/user-guide/process-engine/variables.md#supported-variable-values" >}}) represent Java objects. That means they have a serialized value along with a Java type name that is used to deserialize the value into a Java object. When migrating between processes of different process
