...
If you use [Delegation Code]({{< ref "/manual/user-guide/process-engine/delegation-code.md" >}}), you can access the CMMN model instance and current element of the executed case. If a CMMN model is accessed, it will be cached to avoid redundant database queries.
