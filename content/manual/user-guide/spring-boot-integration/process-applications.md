...
This also allows all `processes.xml` configuration features described [here] ({{<ref "/manual/user-guide/process-applications/the-processes-xml-deployment-descriptor.md">}}).
...
Some configuration can be done via Spring Boot configuration parameters. Check [the list of currently available parameters]({{<ref "/manual/user-guide/spring-boot-integration/configuration.md#camunda-bpm-application">}}).
