...
<table class="table desc-table">
  ...
  <tr>
    ...
    <td>
      The <a href="{{< ref "/manual/user-guide/process-engine/database/database-configuration.md#example-database-configuration" >}}">Database Configuration</a>
  ...
  <tr>
    ...
    <td>
      ...
      <a href="{{< ref "/manual/user-guide/process-engine/history/history-configuration.md#choose-a-history-level">}}">FULL</a>.
    </td>
...
[engine-properties]: {{< ref "/manual/reference/deployment-descriptors/tags/process-engine.md#configuration-properties" >}}
[executor-properties]: {{< ref "/manual/reference/deployment-descriptors/tags/job-executor.md#job-acquisition-configuration-properties" >}}
...
[jta-transaction-integration]: {{< ref "/manual/user-guide/cdi-java-ee-integration/jta-transaction-integration.md">}}
