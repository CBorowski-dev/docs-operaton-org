...
[Process Application Execution Event Listener]({{< ref "/manual/user-guide/process-applications/process-application-event-listeners.md" >}}).

Example configuration for [Servlet Process Application]({{< ref "/manual/user-guide/process-applications/the-process-application-class.md#the-servletprocessapplication" >}}):
...
Example configuration for [EJB Process Application]({{< ref "/manual/user-guide/process-applications/the-process-application-class.md#the-ejbprocessapplication" >}}):
