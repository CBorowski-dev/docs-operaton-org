...
See the [User Guide]({{< ref "/manual/user-guide/_index.md" >}}) for details.
...
[bpm-platform-xml-config]: {{< ref "/manual/reference/deployment-descriptors/descriptors/bpm-platform-xml.md#configure-location-of-the-bpm-platform-xml-file" >}}
[db-schema-install]: {{< ref "/manual/installation/database-schema.md" >}}