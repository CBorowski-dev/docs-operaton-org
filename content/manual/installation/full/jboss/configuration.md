...
If you use LDAP as Identity Provider, you should consider [activating caching]({{< ref "/manual/reference/rest/overview/hal.md#caching-of-hal-relations" >}}) of
...
3. [Configure the process engine plugin]({{< ref "/manual/user-guide/runtime-container-integration/jboss.md#extend-a-process-engine-using-process-engine-plugins" >}}) in the standalone.xml/domain.xml configuration file
