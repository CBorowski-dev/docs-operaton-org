...
<table class="table table-striped">
  ...
  <tr>
    <th>Constraints</th>
    <td colspan="2">
      The <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#connectorid" >}}">
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/events/message-events.md#message-intermediate-throwing-event" >}}">
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#connectorid" >}}">
...
<table class="table table-striped">
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#connector" >}}">
      camunda:connector</a>
    </td>
  </tr>
  <tr>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Metadata of an individual validation constraint for a form field (see <a href="{{< ref "/manual/user-guide/task-forms/_index.md#form-field-validation" >}}">Form Field Validation</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#validation" >}}">camunda:validation</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#map" >}}">camunda:map</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#list" >}}">camunda:list</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#map" >}}">camunda:map</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#script" >}}">camunda:script</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/events/error-events.md#defining-an-error" >}}">errorEventDefinition</a>
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/tasks/service-task.md" >}}">Service Task</a> of type <code>external</code>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      see <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-attributes.md#class" >}}">camunda:class</a>
    </td>
  </tr>
  <tr>
    <td></td>
    <td><code>expression</code></td>
    <td>
      see <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-attributes.md#expression" >}}">camunda:expression</a>
    </td>
  </tr>
  <tr>
    <td></td>
    ...
    <td>
      see <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-attributes.md#delegateexpression" >}}">camunda:delegateExpression</a>
    </td>
  </tr>
  <tr>
    <th>Constraints</th>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/gateways/sequence-flow.md" >}}">Sequence Flow</a>,
      ...
      <a href="{{< ref "/manual/reference/bpmn20/events/start-events.md" >}}">Start Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/_index.md" >}}">Intermediate Catch Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/_index.md" >}}">Intermediate Throw Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/_index.md" >}}">End Events</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/_index.md" >}}">Boundary Events</a>,
      ...
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/event-subprocess.md" >}}">Event Subprocess</a>,
...
<tr>
  <th>Description</th>
  <td colspan="2">
    Defines an expression to inject in delegated classes (see <a href="{{< ref "/manual/user-guide/process-engine/delegation-code.md#field-injection" >}}">Field Injection</a>).
  </td>
</tr>
<tr>
  <th>Attributes</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Defines the custom retry schedule for a failed job (see <a href="{{< ref "/manual/user-guide/process-engine/the-job-executor.md#failed-jobs" >}}">Failed Jobs</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/tasks/script-task.md" >}}">Script Task</a>,
      <a href="{{< ref "/manual/reference/bpmn20/tasks/receive-task.md" >}}">Receive Task</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/timer-events.md#timer-start-event" >}}">Timer Start Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/timer-events.md#timer-intermediate-catching-event" >}}">Timer Intermediate Catching Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/timer-events.md#timer-boundary-event" >}}">Timer Boundary Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/signal-events.md" >}}">Intermediate Signal Throw Event</a>,
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/embedded-subprocess.md" >}}">Embedded Subprocess</a>,
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/call-activity.md" >}}">Call Activity</a>,
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/transaction-subprocess.md" >}}">Transaction Subprocess</a>,
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Defines the value to inject in delegated classes (see <a href="{{< ref "/manual/user-guide/process-engine/delegation-code.md#field-injection" >}}">Field Injection</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#expression" >}}">camunda:expression</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#string" >}}">camunda:string</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Metadata to define fields of a form, which are used to generate task forms (see <a href="{{< ref "/manual/user-guide/task-forms/_index.md#generated-task-forms" >}}">Generated Task Forms</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#formfield" >}}">camunda:formField</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Metadata to define a single form field (see <a href="{{< ref "/manual/user-guide/task-forms/_index.md#generated-task-forms" >}}">Generated Task Forms</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#properties" >}}">camunda:properties</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#validation" >}}">camunda:validation</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#value" >}}">camunda:value</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Metadata to define a form field (<strong>Deprecated</strong>, use <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#formdata" >}}">camunda:formData</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      The element specifies variables which should be passed to the subprocess, see <a href="{{< ref "/manual/reference/bpmn20/subprocesses/call-activity.md#passing-variables" >}}">passing variables</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    ...
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/call-activity.md" >}}">Call Activity</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/signal-events.md" >}}">Signal Events (in Intermediate and End Throwing Events)</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#list" >}}">
        camunda:list</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#map" >}}">
        camunda:map</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#script" >}}">
        camunda:script</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/tasks/_index.md" >}}">All Tasks</a>,
      <a href="{{< ref "/manual/reference/bpmn20/events/_index.md" >}}">All Events</a> (except Start and Boundary Events),
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/call-activity.md" >}}">Call Activity</a>,
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/embedded-subprocess.md" >}}">Embedded Subprocess</a>,
      <a href="{{< ref "/manual/reference/bpmn20/subprocesses/transaction-subprocess.md" >}}">Transaction Subprocess</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#connector" >}}">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#inputparameter" >}}">
        camunda:inputParameter</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#outputparameter" >}}">
...
<table class="table table-striped">
  <tr>
    ...
    <td colspan="2">
      ...
      A <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#script" >}}">
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#outputparameter" >}}">
        camunda:outputParameter</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#list" >}}">camunda:list</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#entry" >}}">camunda:entry</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      The element specifies variables which should be passed back from the subprocess, see <a href="{{< ref "/manual/reference/bpmn20/subprocesses/call-activity.md#passing-variables" >}}">passing variables</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#property" >}}">camunda:property</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      equivalent to <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-attributes.md#resource" >}}">
      camunda:resource</a>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#entry" >}}">camunda:entry</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#list" >}}">camunda:list</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#executionlistener" >}}">
        camunda:executionListener</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#tasklistener" >}}">
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Defines a String value to inject in delegated classes (see <a href="{{< ref "/manual/user-guide/process-engine/delegation-code.md#field-injection" >}}">Field Injection</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
...
<table class="table table-striped">
  ...
  <tr>
    <td></td>
    <td colspan="2">
      If the attribute <code>event</code> is set to <code>timeout</code>, the attribute <code>id</code> and exactly one child element of type <a href="{{< ref "/manual/reference/bpmn20/events/timer-events.md#defining-a-timer" >}}">timerEventDefinition</a> are mandatory
    </td>
  </tr>
  <tr>
    <th>Parent elements</th>
  ...
  <tr>
    ...
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#field" >}}">camunda:field</a>,
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#script" >}}">camunda:script</a>,
	  <a href="{{< ref "/manual/reference/bpmn20/events/timer-events.md#defining-a-timer" >}}">timerEventDefinition</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Metadata to define a list of validation constraints for form fields (see <a href="{{< ref "/manual/user-guide/task-forms/_index.md#form-field-validation" >}}">Form Field Validation</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/bpmn20/custom-extensions/extension-elements.md#constraint" >}}">camunda:constraint</a>
    </td>
  </tr>
</table>
