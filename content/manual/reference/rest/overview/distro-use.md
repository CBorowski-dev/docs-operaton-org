...
Authentication is deactivated by default, but can be activated as described in the [Authentication]({{< ref "/manual/reference/rest/overview/authentication.md" >}}) section.
