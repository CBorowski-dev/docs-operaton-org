...
[inputVariable]: {{< ref "/manual/reference/dmn/custom-extensions/camunda-attributes.md#inputvariable" >}}
[input entry]: {{< ref "/manual/reference/dmn/decision-table/rule.md#input-entry-condition" >}}
