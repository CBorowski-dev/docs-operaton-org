...
It has a `href` attribute and the value starts with `#` followed by the [decision id]({{< ref "/manual/reference/dmn/decision-table/_index.md#decision-id" >}}) of the required decision.
...
[deployed]: {{< ref "/manual/user-guide/process-engine/decisions/repository.md#deploying-a-decision" >}}
[decision literal expression]: {{< ref "/manual/reference/dmn/decision-literal-expression/_index.md" >}}
[id]: {{< ref "/manual/reference/dmn/decision-table/_index.md#decision-id" >}}
[name]: {{< ref "/manual/reference/dmn/decision-table/_index.md#decision-name" >}}
