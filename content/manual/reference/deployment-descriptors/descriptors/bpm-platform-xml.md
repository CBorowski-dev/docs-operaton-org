...
*   [Apache Tomcat]({{< ref "/manual/installation/full/tomcat/_index.md" >}})
*   [IBM WebSphere Application Server]({{< ref "/manual/installation/full/was/_index.md" >}})
*   [Oracle WebLogic Application Server]({{< ref "/manual/installation/full/wls/_index.md" >}})

{{< note title="Wildfly" class="warning">}}
The <code>bpm-platform.xml</code> file is not used in the Operatondistribution for Wildfly. There, the configuration is added to the central application server configuration file (<code>standalone.xml</code> or <code>domain.xml</code>). The XML schema is the same (i.e., the same elements and properties can be used). See the <a href="{{< ref "/manual/user-guide/runtime-container-integration/jboss.md" >}}">The Operaton Wildfly Subsystem</a> section of the <a href="{{< ref "/manual/user-guide/_index.md" >}}">User Guide</a> for more details.
{{< /note >}}
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td><code>&lt;bpm-platform&gt;</code></td>
    <td>true</td>
    <td>See <a href="{{< ref "/manual/reference/deployment-descriptors/tags/job-executor.md" >}}">job-executor Reference</a></td>
  </tr>
  <tr>
