...
This guide is a syntax reference for the files mentioned below. The <a href="{{< ref "/manual/user-guide/_index.md" >}}">User Guide</a> explains when and how to use the deployment descriptors.
