...
The job executor tag is used to configure the job executor and can be placed in the [bpm-platform.xml]({{< ref "/manual/reference/deployment-descriptors/descriptors/bpm-platform-xml.md" >}}) file.
