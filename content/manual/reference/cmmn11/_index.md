...
<div class="cmmn-symbols">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="bpmn-symbol-container implemented">
        <a href="{{< ref "/manual/reference/cmmn11/grouping-tasks/stage.md" >}}"><span class="glyphicon glyphicon-eye-open"></span></a>
  ...
  <div class="row">
    <div class="col-md-12">
      <h3>Tasks</h3>
      <div class="bpmn-symbol-container implemented">
        <a href="{{< ref "/manual/reference/cmmn11/tasks/human-task.md" >}}"><span class="glyphicon glyphicon-eye-open"></span></a>
      ...
      <div class="bpmn-symbol-container implemented">
        <a href="{{< ref "/manual/reference/cmmn11/tasks/process-task.md" >}}"><span class="glyphicon glyphicon-eye-open"></span></a>
        {{< cmmn-symbol type="process-task-colored" >}}
      </div>
      <div class="bpmn-symbol-container implemented">
        <a href="{{< ref "/manual/reference/cmmn11/tasks/case-task.md" >}}"><span class="glyphicon glyphicon-eye-open"></span></a>
        {{< cmmn-symbol type="case-task-colored" >}}
      </div>
      <div class="bpmn-symbol-container implemented">
        <a href="{{< ref "/manual/reference/cmmn11/tasks/decision-task.md" >}}"><span class="glyphicon glyphicon-eye-open"></span></a>
  ...
  <div class="row">
    <div class="col-md-9">
      ...
      <div class="bpmn-symbol-container implemented">
        <a href="{{< ref "/manual/reference/cmmn11/milestone.md" >}}"><span class="glyphicon glyphicon-eye-open"></span></a>
...
<table class="table table-bordered table-responsive table-cmmn-events">
  <thead>
    ...
    <tr class="collapse-bottom">
      ...
      <td>
        <a class="text" href="{{< ref "/manual/reference/cmmn11/sentry.md" >}}">Entry Criterion</a>
        {{< cmmn-symbol type="marker-entry-criterion" >}}
      </td>
      <td>
        <a class="text" href="{{< ref "/manual/reference/cmmn11/sentry.md" >}}">Exit Criterion</a>
        {{< cmmn-symbol type="marker-exit-criterion" >}}
      </td>
      <td>
        <a class="text" href="{{< ref "/manual/reference/cmmn11/markers/auto-complete.md" >}}">AutoComplete</a>
        {{< cmmn-symbol type="marker-auto-complete" >}}
      </td>
      <td>
        <a class="text" href="{{< ref "/manual/reference/cmmn11/markers/manual-activation-rule.md" >}}">Manual Activation</a>
        {{< cmmn-symbol type="marker-manual-activation" >}}
      </td>
      <td>
        <a class="text" href="{{< ref "/manual/reference/cmmn11/markers/required-rule.md" >}}">Required</a>
        {{< cmmn-symbol type="marker-required" >}}
      </td>
      <td>
        <a class="text" href="{{< ref "/manual/reference/cmmn11/markers/repetition-rule.md" >}}">Repetition</a>
  ...
  <tbody>
    <tr>
      <td><a href="{{< ref "/manual/reference/cmmn11/grouping-tasks/stage.md" >}}">Case Plan Model</a></td>
      <td>
    ...
    <tr>
      <td><a href="{{< ref "/manual/reference/cmmn11/grouping-tasks/stage.md" >}}">Stage</a></td>
      <td>
        <span class="glyphicon glyphicon-remove"></span>
      </td>
      <td>
    ...
    <tr>
      <td><a href="{{< ref "/manual/reference/cmmn11/tasks/_index.md" >}}">Task</a></td>
      <td>
        <span class="glyphicon glyphicon-remove"></span>
      </td>
      <td>
    ...
    <tr>
      <td><a href="{{< ref "/manual/reference/cmmn11/milestone.md" >}}">Milestone</a></td>
      <td></td>
      <td>
        <span class="glyphicon glyphicon-ok"></span>
      </td>
