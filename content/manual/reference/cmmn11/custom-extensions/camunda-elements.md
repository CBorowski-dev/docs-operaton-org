...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      see <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-attributes.md#class" >}}">camunda:class</a>
    </td>
  </tr>
  <tr>
    <td></td>
    ...
    <td>
      see <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-attributes.md#expression" >}}">camunda:expression</a>
    </td>
  </tr>
  <tr>
    <td></td>
    ...
    <td>
      see <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-attributes.md#delegateexpression" >}}">camunda:delegateExpression</a>
    </td>
  </tr>
  <tr>
    <th>Constraints</th>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/manual/reference/cmmn11/grouping-tasks/stage.md" >}}">Stage</a>,
      <a href="{{< ref "/manual/reference/cmmn11/milestone.md" >}}">Milestone</a>,
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#field" >}}">camunda:field</a>,
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#script" >}}">camunda:script</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#expression" >}}">camunda:expression</a>,
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#string" >}}">camunda:string</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      This element specifies variables which should be passed to the sub instance (process instance or case instance), see <a href="{{< ref "/manual/reference/cmmn11/tasks/process-task.md#exchange-variables" >}}">passing variables to called process</a> or <a href="{{< ref "/manual/reference/cmmn11/tasks/case-task.md#exchange-variables" >}}">passing variables to called case</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      This element specifies variables which should be passed back from the sub instance (process instance or case instance), see <a href="{{< ref "/manual/reference/cmmn11/tasks/process-task.md#exchange-variables" >}}">passing variables to called process</a> or <a href="{{< ref "/manual/reference/cmmn11/tasks/case-task.md#exchange-variables" >}}">passing variables to called case</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      equivalent to <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-attributes.md#resource" >}}">
      camunda:resource</a>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#variablelistener" >}}">
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Add variableOnPart to sentry. see <a href="{{< ref "/manual/reference/cmmn11/sentry.md#variableonpart" >}}">variableOnPart.
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
    ...
    <td>
      see <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-attributes.md#variablename" >}}">camunda:variableName
    </td>
  </tr>
  <tr>
    <th>Constraints</th>
  ...
  <tr>
    ...
    <td colspan="2">
      <a href="{{< ref "/manual/reference/cmmn11/sentry.md" >}}">Sentries</a>
    </td>
  </tr>
  <tr>
    <th>Child element</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#variableevent" >}}">camunda:variableEvent</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Parent element</th>
    <td colspan="2">
      <a href="{{< ref "/manual/reference/cmmn11/custom-extensions/camunda-elements.md#variableonpart" >}}">VariableOnPart</a>
    </td>
  </tr>
</table>
