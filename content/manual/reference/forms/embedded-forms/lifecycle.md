...
<ol>
  ...
  <br/>
  <li>
    Finally, the form is completed. Triggering an [BPMN error or escalation event]({{< ref "/manual/reference/bpmn20/tasks/user-task.md#reporting-bpmn-error" >}}) will submit the form .<br/>
    <em>Events:</em>
    <ul>
...
Event listeners can be registered from [custom JavaScript]({{< ref "/manual/reference/forms/embedded-forms/javascript/_index.md" >}}):
