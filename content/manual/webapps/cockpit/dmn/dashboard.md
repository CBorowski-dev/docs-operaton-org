...
The decisions dashboard of Cockpit is the entry point for decision monitoring. It comes with a pre-installed plugin, which lets you see deployed decision definitions. Additional [plugins]({{< ref "/manual/webapps/cockpit/extend/plugins.md" >}}) can be added to the decisions dashboard.
...
[decision-definition-view]: {{< ref "/manual/webapps/cockpit/dmn/decision-definition-view.md" >}}
[decision-instance-view]: {{< ref "/manual/webapps/cockpit/dmn/decision-instance-view.md" >}}
