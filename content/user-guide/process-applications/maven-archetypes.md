...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/archetype/camunda-archetype-cockpit-plugin/">Operaton Cockpit Plugin</a></td>
    ...
    <tr>
      ...
      <td>Process application that uses a shared Operatonengine in a Java EE Container, e.g., Wildfly.
    ...
    <tr>
      ...
      <td>Process application that uses a shared Operatonengine in a Servlet Container, e.g., Apache Tomcat.
    ...
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/archetype/camunda-archetype-spring-boot/">Operaton Spring Boot Application</a></td>
    ...
    <tr>
      <td><a href="https://artifacts.camunda.com/artifactory/camunda-bpm/org/camunda/bpm/archetype/camunda-archetype-spring-boot-demo/">Operaton Spring Boot Application with Demo Users</a></td>
...
{{< img src="../img/eclipse-05-specify-maven-coordinates-and-camunda-version.png" title="Eclipse: Specify Maven coordinates and Operaton version" >}}
