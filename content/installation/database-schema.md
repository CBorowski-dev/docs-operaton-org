...
This document will guide you through the installation and update of the Operaton[database schema]({{< ref "/user-guide/process-engine/database/database-schema.md" >}}) used by the process engine.
...
Operatonsupports a variety of databases that are documented in the [supported environments]({{< ref "/introduction/supported-environments.md#databases" >}}).
...
In case you are just updating to a newer patch level of your Operatoninstallation, a schema update might not be necessary.
