...
already done, make sure to download the [Operaton JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.14/)
or [Operaton Wildfly distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly/7.14/). In the following instructions
