...
already done, make sure to download the [Operaton JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.8/), [Operaton Wildfly 8](https://downloads.camunda.cloud/release/camunda-bpm/wildfly8/7.8/)
or [Operaton Wildfly 10 distribution](https://downloads.camunda.cloud/release/camunda-bpm/wildfly10/7.8/). In the following instructions
