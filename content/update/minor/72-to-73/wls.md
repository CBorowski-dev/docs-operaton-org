...
In addition to the core libraries, there may be optional artifacts in `$WLS_DOMAIN_HOME/lib` for LDAP integration, Operaton Connect, and Operaton Spin. If you use any of these extensions, the following update steps apply:
