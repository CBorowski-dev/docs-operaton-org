...
Uninstall the Operaton EAR; its name should be `camunda-ibm-websphere-ear-7.17.0-ee.ear`.
...
Install the Operaton EAR, or the file `$WAS_DISTRIBUTION/modules/camunda-ibm-websphere-ear-7.18.0-ee.ear`.
