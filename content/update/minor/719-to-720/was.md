...
Support for WebSphere 9 was discontinued with the Operaton release. The artifacts used in this guide might be compatible with a WebSphere 9 application server. However, this is not tested and is not covered by Operaton product support.
{{< /note >}}
...
Install the Operaton EAR, or the file `$WAS_DISTRIBUTION/server/apps/camunda-ibm-websphere-ear-7.20.0-ee.ear`.
