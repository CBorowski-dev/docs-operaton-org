...
This document guides you through the update from Operaton `7.18.x` to `7.19.0` and covers the following use cases:
...
6. For developers: [Operaton external task client JS update](#camunda-external-task-client-js-update)
...
Before starting, ensure you have downloaded the Operaton distribution for the application server you use.
...
# Operaton external task client JS update
...
This means that the latest 3.0 version of the [Operaton external task client JS](https://github.com/camunda/camunda-external-task-client-js/)
...
* Operaton WildFly Subsystem under `$WILDFLY_HOME/modules/org/camunda/bpm/$APP_SERVER/camunda-wildfly-subsystem`
